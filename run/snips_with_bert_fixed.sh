...
fix_pretrained_model=true # true, false
...
optimizer=adam # bertAdam, adam
learning_rate=1e-3 # 1e-5, 5e-5, 1e-4, 1e-3
max_norm_of_gradient_clip=5
dropout_rate=0.5 # 0.1, 0.5
